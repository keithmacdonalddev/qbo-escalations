...
const STATUS_BY_CODE = new Map([
  ...
  ['PROVIDER_PACKAGE_MONGO_UNAVAILABLE', 503],
  ['PROVIDER_PACKAGE_CAPTURE_FAILED', 502],
  ['PROVIDER_PACKAGE_LOAD_TIMEOUT', 504],
  ['PROVIDER_HTTP_ERROR', 502],
  ['PROVIDER_INVALID_JSON', 502],
  ['PARSE_FAILED', 422],
  ['PARSER_EMPTY_RESULT', 422],
  ['SERVICE_UNAVAILABLE', 503],
  ['STREAM_INCOMPLETE', 502],
  ['SSE_STREAM_TIMEOUT', 504],
  ['TIMEOUT', 504],
