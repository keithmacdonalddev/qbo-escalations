---
name: qbo-escalations-project
description: Use for qbo-escalations product, server, client, provider harness, prompt, knowledge, observability, agent, workspace, or coding-harness work that needs fast project orientation and safe file routing.
---

# QBO Escalations Project

Read `AGENTS.md`, `PRODUCT_NORTH_STAR.md` when product framing matters, and only the files directly governing the task.
