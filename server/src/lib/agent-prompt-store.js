...
const AGENT_PROMPT_DEFINITIONS = Object.freeze([
  ...
  },
  {
    ...
    promptType: 'system',
    usedBy: 'QBO Canada KB draft generation and review preparation',
    description: 'Single prompt for creating review-ready QBO Canada KB drafts from finished escalation evidence.',
    filePath: path.join(AGENT_PROMPTS_ROOT, 'knowledgebase-agent.md'),
  },
  {
