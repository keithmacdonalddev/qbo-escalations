...
- Hardened provider-list discovery on 2026-07-21: separated account visibility from maintained release evidence, added dated official-source reviews, pagination, irrelevant-surface filtering, missing-model warnings, fail-closed response checks, preserved last-success evidence, and blocked browser-only approval of unknown cloud models.
