...
- Uses Sonnet 5 for the direct Anthropic default, GPT-5.6 Sol for the Codex CLI default, and Gemini 3.6 Flash for Gemini. Gemini 3.5 Flash remains a separately positioned current stable choice; Gemini 3.5 Flash-Lite replaces 3.1 Flash-Lite; Gemini 3.1 Pro Preview remains available.
...
- Refreshed Gemini and Kimi again on 2026-07-21: added Gemini 3.6 Flash, Gemini 3.5 Flash, Gemini 3.5 Flash-Lite, and Kimi K3; removed superseded current choices without rewriting saved profiles; centralized K3/K2.7/legacy K2 request compatibility; and changed Kimi key validation to read-only model discovery.
- Hardened provider-list discovery on 2026-07-21: separated account visibility from maintained release evidence, added dated official-source reviews, pagination, strict newer-than-catalog version floors, irrelevant-surface filtering, missing-model warnings, fail-closed response checks, preserved last-success evidence, and blocked browser-only approval of unknown cloud models. Older, same-generation, and ambiguous provider IDs are no longer shown as discoveries.
